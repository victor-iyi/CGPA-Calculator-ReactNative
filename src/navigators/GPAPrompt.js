  ...
  render( ) {
    return (
      <View style={styles.container}>
        <NumberButtons result={this.state.result} prompt="Enter number of semesters completed & press go!" controlButton={this._controlButton} numButton={this._numButton}/>
      </View>
    );
  }
